...
exports.webbSida = function(){

    //importera inbyggt kodbibliotek och skapar variabeln fil
    const fs = require('fs'); 
    const http = require('http');

    let fil;

//funktion som frågar om response, omg filen är /, alltså startsida
function startSida(req){
